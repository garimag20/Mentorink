...
import {e} from './MenteeDashboard';

const ViewMentor = props => {

    // const mentor = {name: "Peter Parker", phoneNumber: 9763726263, interest1: 'Dancing', interest2: 'Singing', interest3: 'Sports', state: 'Maharshtra', language: 'English', career: 'Engineering'}

    return (
        <div>
            <h1 className="pt-5"><center>My Mentor</center></h1>
