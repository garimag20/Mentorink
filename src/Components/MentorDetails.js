...
const MentorDetails = props => {
    ...
    // const mentor = {firstName: "Peter", lastName: "Parker", phoneNumber: 9763726263, hobby1: 'Dancing', hobby2: 'Singing', hobby3: 'Sports', gender: 'Male', state: 'Maharshtra', language: 'English', career: 'Engineering'};
